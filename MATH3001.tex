...
\item Trenches: similar to filter strips but with the aim of storing rainwater to gradually be released into the ground as opposed to transporting the rainwater to an alternative storage facility.
...
\item Bioretention Systems: also known as rain gardens, are shallow bowls in the ground that capture, and more significantly, treat rainwater.
...
\begin{figure}[h!]
\centering
\subfloat[Figure 5]{\includegraphics[width=0.5\textwidth]{Warwick-Quadrant_Graph.png}}
\hfill
